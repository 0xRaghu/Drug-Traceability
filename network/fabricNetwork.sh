...
function printHelp() {
  echo "Usage: "
  echo "  fabricNetwork.sh <mode> [-c <channel name>] [-t <timeout>] [-d <delay>] [-f <docker-compose-file>] [-s <dbtype>] [-l <language>] [-o <consensus-type>] [-i <imagetag>] [-v]"
  ...
  echo "  fabricNetwork.sh -h (print this message)"
  echo
